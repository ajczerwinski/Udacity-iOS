...
class FavoritesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        parentViewController!.navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .Reply, target: self, action: #selector(FavoritesViewController.logout))
    }
