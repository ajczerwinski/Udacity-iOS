...
class LoginViewController: UIViewController {
     ...
     **************************************************************************************
     **************************************************************************************
     COMMENTING OUT getRequestToken(), loginWithToken(requestToken: String),
     getSessionID(requestToken: String), and getUserID(sessionID: String) BECAUSE THEY ARE
     NOW ABSTRACTED OVER TO THE TMDBConvenience.swift FILE
     **************************************************************************************
     **************************************************************************************
     **************************************************************************************
